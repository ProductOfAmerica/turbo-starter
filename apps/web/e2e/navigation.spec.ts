...
test.describe('Navigation', () => {
	test('anchor link scrolls to features section', async ({ page, homePage }) => {
		await page.locator('a[href="#features"]').first().click();
		await expect(page.locator('section#features')).toBeInViewport();
	});

	test('anchor link scrolls to quick start section', async ({ page, homePage }) => {
	...
	test('external links have correct hrefs', async ({ page, homePage }) => {
...
test.describe('Responsive: mobile', () => {
	...
	test('mobile menu button is visible', async ({ page, homePage }) => {
...
test.describe('Responsive: desktop', () => {
	...
	test('desktop nav links are visible', async ({ page, homePage }) => {
